  ...
  return (
    ...
    >
        ...
        <div className="flex gap-[50px] md:gap-[75px] lg:gap-[100px] flex-col md:flex-row">
          ...
          <div className="flex flex-col gap-3 shrink-0">
            ...
            <p className="w-[200px] text-[16px] font-medium text-black">
              مركز النخبة لطب وتقويم الأسنان هو مركز رائد في مجال الرعاية الصحية
              الفموية والأسنان.
            </p>
          </div>
          {/* LOGO END */}
            ...
            <div className="mt-5 flex gap-2">
              ...
              <div className="">
                ...
                <p className="text-[16px] font-medium">
                  الزقازيق - المفارق نهاية شارع المحافظة -أمام السجل المدني برج
                  قصر الحياة الدور الثاني
                </p>
      ...
      <Wrapper className="flex justify-between mt-10 flex-col md:flex-row gap-[10px] md:gap-0">
        {/* LEFT START */}
        <div className="flex flex-row-reverse items-center text-[16px] text-black/[0.8] hover:text-black text-center md:text-left">
          Created by{" "}
          <img src="/blackLogo.png" alt="" className="h-[20px] ml-2" />
        </div>
        {/* LEFT END */}
